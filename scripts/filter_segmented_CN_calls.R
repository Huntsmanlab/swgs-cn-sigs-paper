...
# THE FILTRATION STEP SHOULD BE INCLUDED IN A VIGNETTE FOR THE UTANOS PACKAGE
# THE FILTRATION STEP SHOULD BE INCLUDED IN A VIGNETTE FOR THE UTANOS PACKAGE
# THE FILTRATION STEP SHOULD BE INCLUDED IN A VIGNETTE FOR THE UTANOS PACKAGE
# THE FILTRATION STEP SHOULD BE INCLUDED IN A VIGNETTE FOR THE UTANOS PACKAGE
# THE FILTRATION STEP SHOULD BE INCLUDED IN A VIGNETTE FOR THE UTANOS PACKAGE
...
##### Get input CN calls
#####
input_obj <- '~/Documents/projects/cn_sigs_swgs/copy_number_objects/wisecondorX_Xchr_included/wx_qdnaobj.rds'
# THE FILTRATION STEP SHOULD BE INCLUDED IN A VIGNETTE FOR THE UTANOS PACKAGE
# THE FILTRATION STEP SHOULD BE INCLUDED IN A VIGNETTE FOR THE UTANOS PACKAGEinput_obj <- readRDS(input_obj)
# Get commonly CN variable regions in hg19
com_CNVs <- '~/repos/cnsignatures/data/external_datasets/GRCh37_hg19_common_variants_20200225.tsv'
com_CNVs <- read.table(file = com_CNVs, header = TRUE, sep = "\t")
# Get commonly CN variable regions in EC
EC_com_CNVs <- '~/repos/cnsignatures/data/external_datasets/common_hg19_EC_CNA_genes_TCGA.txt'
EC_com_CNVs <- data.table::fread(file = EC_com_CNVs, header = TRUE, sep = "\t", fill = TRUE)
# Cross-referencing dataset
cr_ref <- '~/repos/cnsignatures/data/external_datasets/gene_names_symbols_crossreference.txt'
cr_ref <- data.table::fread(file = cr_ref, header = TRUE, sep = '\t')
...
##### Save output
#####
saveRDS(ccnvFILT_obj, file = '~/Documents/projects/cn_sigs_swgs/copy_number_objects/wisecondorX_Xchr_included/30kb_rCN_comCNVfilt.rds')
saveRDS(cEC_CNV_obj, file = '~/Documents/projects/cn_sigs_swgs/copy_number_objects/wisecondorX_Xchr_included/30kb_rCN_eccnvs.rds')
saveRDS(new_obj, file = '~/Documents/projects/cn_sigs_swgs/copy_number_objects/wisecondorX_Xchr_included/30kb_rCN_NOeccnvs.rds')
